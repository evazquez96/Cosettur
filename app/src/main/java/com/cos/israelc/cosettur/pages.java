...
public class pages extends Activity implements OnClickListener{
    ...
    class RetreiveFeedTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                message.setContent("Gracias por Usar CosetturApp  de clic en el seguiente enlace para recuperar su contraseña "+"/n"+"https://sites.google.com/view/recuperacioncosettur/p%C3%A1gina-principal", "text/html; charset=utf-8");
